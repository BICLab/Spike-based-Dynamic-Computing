...
def main():
    ...
    if args.local_rank == 0:
        summary(net, (args.T, 4, 2, 224, 224))
    ...
    args.out_dir = "./final_result"
    out_dir = os.path.join(
        args.out_dir,
        f"T{args.T}_b{args.b}_{args.opt}_lr{args.lr}_HARDVS_attn_{args.attn}_where_{args.attn_where}_epochs_{args.epochs}_IF",
    )
    if args.amp:
        out_dir += "_amp"
    if args.cupy:
