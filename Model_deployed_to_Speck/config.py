...
parser.add_argument('-data_path', type=str, default='./data/DVSGesture/')
...
parser.add_argument('-RM', type=bool, default=True)
parser.add_argument('-reserve_coefficient', type=bool, default=True)
...
# parser.add_argument('-lr_scheduler_epoch', type=int, default=25)
